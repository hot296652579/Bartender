...
const _preloadBundles = [ModuleDef.BASIC, ModuleDef.MODULE_TAKE_GOBLET];
...
const _preloadRes = [
    ...
    { bundle: ModuleDef.MODULE_TAKE_GOBLET, url: 'Audio/luosi.mp3', type: 'audio' },
    { bundle: ModuleDef.MODULE_TAKE_GOBLET, url: 'Audio/shengli.mp3', type: 'audio' },
    { bundle: ModuleDef.MODULE_TAKE_GOBLET, url: 'Audio/shibai.mp3', type: 'audio' },
    { bundle: ModuleDef.MODULE_TAKE_GOBLET, url: 'Audio/yidong.mp3', type: 'audio' },
    { bundle: ModuleDef.MODULE_TAKE_GOBLET, url: 'Audio/zhuangche.mp3', type: 'audio' },
];
...
export class Start extends Component {
    ...
    onPreloadingComplete() {
        let bundle = assetManager.getBundle(ModuleDef.MODULE_TAKE_GOBLET);
        bundle.preloadScene(SceneDef.ROOSTER_HOLE, () => {
            this.onResLoaded();
            // director.loadScene(SceneDef.MAIN_MENU);

            const info = {
                bundle: 'module_take_goblet',
                entryScene: 'rooster_takegoblet'
            }
            tgxUIWaiting.show();
