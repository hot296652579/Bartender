...
tgxModuleContext.attachModule(UI_BattleResult, ModuleDef.MODULE_TAKE_GOBLET);
tgxModuleContext.attachModule(UI_TopInfo, ModuleDef.MODULE_TAKE_GOBLET);
tgxModuleContext.attachModule(UI_ExtraTime, ModuleDef.MODULE_TAKE_GOBLET);
tgxModuleContext.attachModule(UI_Magnetic, ModuleDef.MODULE_TAKE_GOBLET);